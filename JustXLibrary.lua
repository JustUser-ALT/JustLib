    ...
    function Win:Tab(topts)
        ...
        if typ=="Grid" then
            ...
            local function makeGridSection(sopts)
                ...
                task.defer(rebuild)
                return makeSection(col,sopts.Title or "Section",sg,orders[index])
            end
        ...
        elseif typ=="Settings" then
            ...
            local intro=settingsCard(
                "JustXLibrary",
                "Appearance, interface and hub controls are collected here.",
                order
            )
            intro.Size=UDim2.new(1,0,0,70)
            local introIcon=mkIcon(intro,"⚙",26,15)
            introIcon.Position=UDim2.new(1,-42,0.5,-13)
            introIcon.Size=UDim2.new(0,26,0,26)

            order+=1
            local visual=Instance.new("Frame")
            visual.Size=UDim2.new(1,0,0,106)
            ...
            newTxt({Parent=visual,Text="VISUALS",Font=Enum.Font.GothamBold,Size=10,Color=C.dim,
            ...
            blurRow.Position=UDim2.new(0,12,0,66)
            ...
            badge.Size=UDim2.new(1,0,0,122)
            ...
            newTxt({Parent=badge,Text="BADGE POSITION",Font=Enum.Font.GothamBold,Size=10,Color=C.dim,
                Sz=UDim2.new(1,-24,0,18),Pos=UDim2.new(0,12,0,9),Z=15})
            ...
            for i,item in ipairs(positions) do
                ...
                b.Position=UDim2.new(0,12,0,29+(i-1)*29)
            ...
            danger.Size=UDim2.new(1,0,0,92)
            ...
            newTxt({Parent=danger,Text="LIBRARY",Font=Enum.Font.GothamBold,Size=10,Color=C.dim,
                Sz=UDim2.new(1,-24,0,18),Pos=UDim2.new(0,12,0,9),Z=15})

            local closeBtn=Instance.new("TextButton")
            closeBtn.Size=UDim2.new(1,-24,0,27)
            closeBtn.Position=UDim2.new(0,12,0,31)
