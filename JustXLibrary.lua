...
local _,titleLbl=longText(hdr,title,{Host=titleHost,Size=(variant=="Grid" and 12 or 13),XAlign=Enum.TextXAlignment.Left,Z=15})
    ...
    function Sec:Slider(opts)
        ...
        longText(top,opts.Name or "Slider",{Host=host,Size=11,XAlign=Enum.TextXAlignment.Left,Z=17,TextMode=opts.TextMode})
    ...
    function Sec:Dropdown(opts)
        ...
        longText(bg,opts.Name or "Dropdown",{Host=dHost,Size=12,XAlign=Enum.TextXAlignment.Left,Z=18,TextMode=opts.TextMode})
...
function JL:Window(opts)
    ...
    function Win:Tab(topts)
        ...
        elseif typ=="Settings" then
            ...
            local blur=card(right,"Blur Amount","EFFECTS",164,ACCENTS[4])
            ...
            valueBox.Position=UDim2.new(1,-69,0,66)
            ...
            local stateLbl=newTxt({
                ...
                Font=Enum.Font.GothamBold,Size=8,Color=C.dim,
                Sz=UDim2.new(0,100,0,14),Pos=UDim2.new(0,15,0,67),Z=17
            })

            local preview=Instance.new("Frame")
            preview.Size=UDim2.new(1,-30,0,32)
            preview.Position=UDim2.new(0,15,0,108)
            ...
            -- CONFIG MANAGER
            local configCard=card(center,"Config Manager","CONFIG",326,ACCENTS[6])
            ...
            cfgAction(138,"Save Config",saveAs,false)
            cfgAction(176,"Load Config",loadSelected,false)
            cfgAction(214,"Rewrite Config",rewriteSelected,false)
            cfgAction(252,"Delete Config",deleteSelected,true)
            cfgAction(290,"Rename Config",renameSelected,false)
            refreshConfigs()
