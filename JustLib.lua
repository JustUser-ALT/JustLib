...
-- ============================== custom icon packs ==============================
-- Roblox only renders rbxassetid:// images, not raw URLs, so Icon = "name" is resolved
-- through a loaded name -> rbxassetid table (e.g. built from a Footagesus/Icons-style pack).
...
-- merge/override individual icon names, e.g. JL:SetIcons({heart = 123456})
